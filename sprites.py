...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        #image_to_load = pygame.image.load("src/img/single.png")
    ...
    def collide_enemy(self):
        ...
        if hits:
            self.kill()
            self.game.playing = False # se termina el juego
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.max_travel = random.randint(7, 70)
...
class Button:
    ...
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        ...
        self.font = pygame.font.Font("src/fonts/Pokemon Solid.ttf", fontsize)
